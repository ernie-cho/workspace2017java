...
public class k20_distance {
	/*Lec08. 17-05-29, 조영도, 전국무료와이파이표준데이터 - 거리 구하기*/
	public static void main(String[] args) {
		...
		try{
			...
			while((k20_readtxt = k20_br.readLine())!= null){
				...
				/*피타고라스 정리로 거리 구하기*/
				 k20_dist = Math.sqrt( Math.pow(Double.parseDouble(k20_field[12]) - k20_lat, 2)
						+ Math.pow(Double.parseDouble(k20_field[13]) - k20_lng, 2));
				 /*현재지점과 거리 출력*/
				System.out.printf("현재지점과 거리 : %f\n",k20_dist);
				k20_address = k20_field[8];
				/*구분선 넣기*/
				System.out.printf("********************************\n");	
				/*라인 증가*/
				k20_LineCnt++;
